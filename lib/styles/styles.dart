...
class HomeAutomationStyles {
  ...
  static const TextStyle headlineLarge =
      TextStyle(fontSize: HomeAutomationStyles.largeSize);

  static const TextStyle headlineMedium =
      TextStyle(fontSize: HomeAutomationStyles.mediumSize);

  static const TextStyle labelLarge =
      TextStyle(fontSize: HomeAutomationStyles.labelLargeSize);

  static const TextStyle labelMedium =
      TextStyle(fontSize: HomeAutomationStyles.labelMediumSize);
