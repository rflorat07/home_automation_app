...
class Utils {
  ...
  static void showUIModal(BuildContext context, Widget child,
      ...
      showDialog(
          ...
          builder: (ctxt) {
            return FractionallySizedBox(
                widthFactor: 0.5, heightFactor: 0.8, child: child);
          }).whenComplete(() {
        onDismissed!();
      });
    }
  ...
  static void showMessageOnSnack(String title, String message) {
    ...
    final messageStyle =
        theme.contentTextStyle!.copyWith(fontWeight: FontWeight.normal);

    ScaffoldMessenger.of(Utils.mainNav.currentContext!).showSnackBar(SnackBar(
        content: Column(
